...
$(document).ready(function () {
    ...
    function initialize() {
        var lat = 42.6663587;
        var lng = 21.0886868;
        myLatlng = new google.maps.LatLng(42.6663587, 21.0886868);
        iconBase = '/2016/fashion/front/img/';
    ...
    var responsiveNav = function (el, options) {
        ...
        ResponsiveNav.prototype = {
            ...
            _calcHeight: function () {
                ...
                var innerStyles = "." + opts.jsClass + " ." + opts.navClass + "-" + this.index + ".opened{max-height:9999px !important}";
                +opts.jsClass + " ." + opts.navClass + "-" + this.index + ".opened.dropdown-active {max-height:9999px !important}";
